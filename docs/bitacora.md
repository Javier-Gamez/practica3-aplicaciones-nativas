# Bitácora de sesiones de trabajo — Práctica 3
...
Agrega aquí (o enlaza en `docs/evidencia/`) fotografías del equipo trabajando o capturas de
las sesiones remotas con pantalla compartida / videollamada.

## Nota sobre unión con otro equipo (si aplica)

Si no contaron con Mac ni PC capaz de virtualizar macOS y se unieron a otro equipo para los
ejercicios 1, 2 y 3, documenten aquí: equipos participantes, quiénes estuvieron presentes en
cada sesión conjunta y la fecha en que se avisó al docente.
